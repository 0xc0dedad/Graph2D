...
private:
    ...
    void readUIConf(QString filename, QTextStream &stream) const;
    void readGraph(QString filename) const;
    void writeNodeToolTips(QString filename) const;
    QVector<QString> readNodeToolTips(QString filename) const;
